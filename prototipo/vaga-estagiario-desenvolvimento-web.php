    ...
    <div class="container mt-5 my-5 d-flex justify-content-center">
        <div class="row container-form ">
            <div class="card col-12 col-md-6">
                <img class="card-img-top pt-2" src="img/pc.png" alt="Imagem da capa do card">
                <div class="card-body">
            ...
            <div class="col-12 col-md-6 p-4">
                <h4 class="form-label titulo-maior">Vaga - Estagiário de Desenvolvimento Web</h4>
                <form action="" method="POST">
                    <input type="hidden" name="nome_vaga" value="estagiario_desenvolvimento_web">
                    <div class="mb-3">
                        <label>Nome</label>
